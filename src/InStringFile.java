...
public class InStringFile {
	...
	/**
	 * Constructs the object that controls file reading Exits gracefullly if file
	...
	/**
	 * Reads the next line of input as a String Exits gracefully if an error occurs
